...
public interface Bank {
    ...
    void createAccount(String account, List<Transaction> transactions)
            ...
            TransactionAttributeException, IOException, AccountDoesNotExistException;
    ...
    /**
     * Deletes Account from the Bank
     *
     * @param account to be deleted
     * @throws AccountDoesNotExistException is thrown, if an account does not exist
     * @throws IOException                  is thrown, if there is an error during input or output in json file
     */
    void deleteAccount(String account) throws AccountDoesNotExistException, IOException;

    /**
     * Returns all account names in the Bank
     *
     * @return all account names from the Bank
     */
